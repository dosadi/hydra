...
- TODO: Provide ray depth histogram/metrics per frame to guide performance tuning.
...
- TODO: Add a runtime “ray jitter” option to reduce banding and improve visual smoothing.
