...
- **TODO [P2]:** Provide multi-head HDMI support (multiple screens simultaneously) with per-head timing tracks and CRC stats exported to `out/hdmi_multihead.json` for automation dashboards.
