...
- **TODO [P3]:** Maintain a “FPS task catalogue” inside this tracker describing which tasks are short adjustments versus multi-week performance campaigns, helping contributors choose the right-sized TODO entry for their work.
