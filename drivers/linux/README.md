...
- Replace `HYDRA_VENDOR_ID`/`HYDRA_DEVICE_ID` in `hydra_pcie_drv.c` with real IDs.
- Add BAR mapping, DMA mask setup, MSI/MSI-X, and a user-visible interface (`debugfs`, `ioctl`, or a DRM/VFIO path) as needed.
