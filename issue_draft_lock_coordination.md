Title: Add multi-invocation safety (locks + session outputs) to Codex CLI
...
References:
- RFC: /home/jon/temp/hydra/docs/rfc/lock_coordination.md
- Prototype: /home/jon/temp/hydra/prototypes/codex-lock-broker (README, CI, server/lib/tests)
